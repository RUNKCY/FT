...
# 常見問答表
faq = {
    "你好": TextMessage(text="你好，你可以輸入任何文字觀看主選單"
    ),
    "貼圖": StickerMessage(
        package_id="1",
        sticker_id="1"
...
menu = TemplateMessage(
    ...
    template=CarouselTemplate(
        columns=[
            CarouselColumn(
                # 卡片一圖片網址
                thumbnail_image_url="https://pbs.twimg.com/profile_images/760744530421383168/Nj5NSZ56_400x400.jpg",
                title="主選單一",
                text="點選下方按鈕開始互動",
                actions=[
                    MessageAction(
            ...
            CarouselColumn(
                # 卡片二圖片網址
                thumbnail_image_url="https://www.fortmcmurrayoilbarons.ca/wp-content/uploads/sites/11/2023/06/2023-Transaction-838-%C3%97-524-px-1.png",
                title="主選單二",
                text="點選下方按鈕開始互動",
                actions=[
                    MessageAction(
