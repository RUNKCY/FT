...
#本地端測試 cheklist
#開啟ngrok: ./ngrok http 5001 免費啟用的網址每次都不一樣
...
def handle_message(event):
    with ApiClient(configuration) as api_client:
        ...
        if user_msg in faq:
            ...
            bot_msg=TextMessage(text=f"{user_msg}買價:{buy}賣價:{sell}資料來自於台灣銀行公告牌價")
        ...
        line_bot_api.reply_message_with_http_info(
            ReplyMessageRequest(
                ...
                messages=[
                    ...
                    TextMessage(text=f"笨森剛才傳入了一張貼圖，以下是這張貼圖的資訊:"),
